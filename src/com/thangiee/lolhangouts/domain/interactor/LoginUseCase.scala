...
import com.thangiee.lolhangouts.domain.entities.Value.String.{Password, Username, Version}
import com.thangiee.lolhangouts.domain.exception.UseCaseException._
