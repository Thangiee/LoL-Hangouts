package com.jriot.objects;

public class AggregatedStats {

    private int averageAssists = 0;
    private int averageChampionsKilled = 0;
    private int averageCombatPlayerScore = 0;
    private int averageNodeCapture = 0;
    private int averageNodeCaptureAssist = 0;
    private int averageNodeNeutralize = 0;
    private int averageNodeNeutralizeAssist = 0;
    private int averageNumDeaths = 0;
    private int averageObjectivePlayerScore = 0;
    private int averageTeamObjective = 0;
    private int averageTotalPlayerScore = 0;
    private int botGamesPlayed = 0;
    private int killingSpree = 0;
    private int maxAssists = 0;
    private int maxChampionsKilled = 0;
    private int maxCombatPlayerScore = 0;
    private int maxLargestCriticalStrike = 0;
    private int maxLargestKillingSpree = 0;
    private int maxNodeCapture = 0;
    private int maxNodeCaptureAssist = 0;
    private int maxNodeNeutralize = 0;
    private int maxNodeNeutralizeAssist = 0;
    private int maxObjectivePlayerScore = 0;
    private int maxTeamObjective = 0;
    private int maxTimePlayed = 0;
    private int maxTimeSpentLiving = 0;
    private int maxTotalPlayerScore = 0;
    private int mostChampionKillsPerSession = 0;
    private int mostSpellsCast = 0;
    private int normalGamesPlayed = 0;
    private int rankedPremadeGamesPlayed = 0;
    private int rankedSoloGamesPlayed = 0;
    private int totalAssists = 0;
    private int totalChampionKills = 0;
    private int totalDamageDealt = 0;
    private int totalDamageTaken = 0;
    private int totalDeathsPerSession = 0;
    private int totalDoubleKills = 0;
    private int totalFirstBlood = 0;
    private int totalGoldEarned = 0;
    private int totalHeal = 0;
    private int totalMagicDamageDealt = 0;
    private int totalMinionKills = 0;
    private int totalNeutralMinionsKilled = 0;
    private int totalNodeCapture = 0;
    private int totalNodeNeutralize = 0;
    private int totalPentaKills = 0;
    private int totalPhysicalDamageDealt = 0;
    private int totalQuadraKills = 0;
    private int totalSessionsLost = 0;
    private int totalSessionsPlayed = 0;
    private int totalSessionsWon = 0;
    private int totalTripleKills = 0;
    private int totalTurretsKilled = 0;
    private int totalUnrealKills = 0;
